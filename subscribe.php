...
//Normally i wrap this in a debug statement but for bow i want to always
//display it. when you first come to the form it is empty. when you submit
...
$firstName = "";
$lastName = "";
$email = "bridget.lavelle@uvm.edu";
$gender = "Female";
$web = true; //checked
$referral = false;
$advertisement = false;//not checked
$often = "Weekly"; // pick the option
$comments = "";
...
if (isset($_POST["btnSubmit"])){
    ...
    $store = htmlentities($_POST["lstStores"], ENT_QUOTES, "UTF-8");
    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    //
    ...
    if ($totalChecked < 1){
        $errorMsg[] = "Please choose how you found our website.";
        $howERROR = true;
    }
    
    if ($often ==""){
        $errorMsg[] = "Please choose how often you would like a subscription.";
        $oftenError = true;
    }
...
<?php
    //#########################
    //
    print PHP_EOL . '<!-- SECTION: 3a misc variables -->' . PHP_EOL;
    //
    // If its the first time coming ot the form or there are errors we are going 
    // to display the form
...
<form action = "<?php print $phpSelf; ?>"
    ...
    method = "post">
           ...
           <fieldset class="checkbox <?php if ($howERROR) print ' mistake'; ?>">
               <legend>How did you find our website? (choose at least one and check all that apply):</legend>
               
               <p>
                   <label class="check-field"> 
                       <input <?php if ($web) print " checked "; ?>
                           id="chkWeb"
                           name="chkWeb"
                           tabindex="420"
                           type="checkbox"
                           value="Web"> Web Surfing</label>
               </p>
               <p>
                   <label class="check-field">
                       <input <?php if ($referral) print " checked "; ?>
                           id="chkReferral"
                           name="chkReferral"
                           tabindex="430"
                           type="checkbox"
               ...
               <p>
                   <label class="check-field">
                       <input <?php if ($advertisement) print " checked "; ?>
                           id="chkAdvertisement"
                           name="chkAdvertisement"
                           tabindex="430"
                           type="checkbox"
                           value="Advertisement"> Advertisement</label>
               </p>
           </fieldset>
           <fieldset class="listbox <?php if ($oftenERROR) print ' mistake'; ?>">
               <legend>How often would you like a subscription?</legend>
               <p>
                <select id="lstOften"
                        name="lstOften"
                    tabindex="520" >
                  <option <?php if ($often == "Weekly") print " select "; ?>
                      value="Weekly">Weekly</option>
                  <option <?php if ($often == "Monthly") print " selected "; ?>
                      value="Monthly">Monthly</option>
                  <option <?php if ($often == "Yearly") print "selected "; ?>
           ...
           <fieldset class="textarea">
               <p>
                   ...
                   <textarea <?php if ($commentsERROR) print 'class="mistake"'; ?>
                       ...
                       name="txtComments"
                       onfocus="this.select()"
                       tabindex="800"><?php print $comments; ?></textarea>
               </p>
           </fieldset>
